...
var $addCollectionButton = $(
  '<button type="button" class="add_collection_link btn btn-success">Ajouter Stagiaire</button>'
);
var $delCollectionButton = $();
('<button type="button" class="del_collection_link btn btn-danger text-white m-2"><i class="fas fa-trash-alt"></i></button>');
