 ...
 */
final class Version20210515082038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE programmer (id INT AUTO_INCREMENT NOT NULL, session_id INT NOT NULL, module_id INT DEFAULT NULL, duree INT NOT NULL, INDEX IDX_4136CCA9613FECDF (session_id), INDEX IDX_4136CCA9AFC2B591 (module_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
